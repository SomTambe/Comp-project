...
class projWithoutObj2{
    ...
    public static void result(){
        //displays result by object calling
    ...
    public static void main(){
        for(int i=1;i<=4;){
            ...
            System.out.println("Enter 1 to calculate all bills again.");
            System.out.println("Enter 2 to display all bills.");
            System.out.println("Enter 3 to exit directly.");
            endinp=sc.nextInt();
            if(endinp==1){
                i++;
            }
